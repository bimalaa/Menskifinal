        ...
        <div className="bg-muted/20 border-2 p-8 h-fit space-y-8 rounded-none">
          ...
          <div className="space-y-4 text-sm font-medium uppercase tracking-widest">
            ...
            <div className="flex justify-between">
              ...
              <span>Rs. {subtotal > 50 ? "FREE" : "1000"}</span>
            </div>
          </div>
          <div className="flex justify-between text-xl font-bold uppercase tracking-tight border-t pt-4">
            <span>Total</span>
            <span>Rs. {(subtotal > 50 ? subtotal : subtotal + 10).toFixed(2)}</span>
          </div>
          <Link href="/checkout" className="block w-full">
            <Button className="w-full rounded-none py-8 font-bold text-lg" disabled={cartItems.length === 0}>
              Proceed to Checkout
            </Button>
          </Link>
